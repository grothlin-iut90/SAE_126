...
public class RDRDecider extends Decider {

    private static final Random loto = new Random(Calendar.getInstance().getTimeInMillis());

    public RDRDecider(Model model, Controller control) {
        super(model, control);
    }
    ...
    public ActionList decide() {
        ...
        RDRStageModel stage = (RDRStageModel)model.getGameStage();
        RDRBoard board = stage.getBoard(); // get the board
        RDRPawnPot pot = null; // the pot where to take a pawn
        ...
        ActionList actions = ActionFactory.generatePutInContainer( model, pawn, "rdrboard", rowDest, colDest);
